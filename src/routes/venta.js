...
import { infoApi,listarVentas,misCompras,buscarDetalleOrden,cambiarEstadoEntrega,generarReporte,registarCompra,createCompra, eliminarReporte } from '../controllers/ventaController.js';
...
router.get('/propietario/info', infoApi)
